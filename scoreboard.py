...
class Scoreboard():
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        self.font = pygame.font.Font('font/invasion.otf', 30)
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left + 1):
            ...
            ship.rect.x = self.ai_settings.screen_width - \
                ship.rect.width - ship_number * ship.rect.width - 10
            ship.rect.y = 10
            self.ships.add(ship)
...
class Quit_State():
    def __init__(self, ai_settings, screen):
        ...
        self.font = pygame.font.Font('font/invasion.otf', 40)
        self.quit_statement(ai_settings)

    def quit_statement(self, ai_settings):
        quit_state = "|   PRESS  ' Q '  to  QUIT   |   USE  Left - Right  Arrow  Keys  To  MOVE   |"
        self.font = pygame.font.Font('font/invasion.otf', 25)
        self.quit_state = self.font.render(
            quit_state, True, self.text_color, (255, 97, 3))
